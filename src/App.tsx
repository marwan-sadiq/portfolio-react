    ...
    <div className="App">
      ...
      <div className="main-desktop-columns">
        <section className="card about-card">
          ...
          <p className="section-text">Hi, I'm a freelance software developer with a passion for building useful, fast, and modern applications. I specialize in full-stack development using React, React Native, and Django, and I enjoy solving real-world problems through technology.</p>
          <p className="section-text">Over the past year, I've focused on developing practical tools for businesses, including early-stage platforms and internal systems for hospitals. I combine strong technical skills with a fast learning mindset and an eye for clean UI/UX.</p>
          <p className="section-text">Right now, I'm open to freelance projects, collaborations, or contract work. Whether you're looking to build something from scratch or improve what you already have — let's talk.</p>
      ...
      <div className="main-projects-contact-columns">
        <section className="card projects-card" id="projects">
          ...
          <a href={project.github} target="_blank" rel="noopener noreferrer" className="github-float-btn" aria-label="GitHub">GitHub</a>
        </section>
        ...
        <section className="card contact-card" id="contact">
          ...
          <div className="social-row social-row-centered">
